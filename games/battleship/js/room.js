...
const roomID = `battleship_${rawID}`;
...
let roomReceivedOnce = false; // Eviter la redirection sur null transitoire au chargement
...
async function initRoom() {
    ...
    listenToRoomChanges(roomID, (updatedRoom) => {
        if (!updatedRoom) {
            // Ignorer le null transitoire au premier chargement
        ...
        if (updatedRoom.state === "placement" || updatedRoom.state === "playing") {
